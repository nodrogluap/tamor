...
rule dragen_rna_read_mapping_quant_and_fusion_calls:
        ...
        run:
			...
			" --annotation-file "+config["ref_exon_annotations"]+" --force --soft-read-trimmers polyg --read-trimmers adapter --trim-adapter-read1 resources/adapter_sequences/read1_3prime.fasta --trim-adapter-read2 resources/adapter_sequences/read2_3prime.fasta")
