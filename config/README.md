...
Uncommenting the ``set_output_group`` and ``set_output_umask`` lines in vconfig.yaml will make Tamor try to honour those wishes. As per UNIX convention, a umask of 007 
