...
Once variant call (VCF) files are generated, BAM file existence or modifcation date does *not* triggering Tamor workflow rule reruns. 
...
The standalone script can be run *outside* of Tamor's Snakemake workflow, and takes two arguments:
